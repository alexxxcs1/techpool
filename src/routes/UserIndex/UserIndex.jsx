  ...
  render() {
    return (
      <div className={style.UserIndexBox}>
        {this.state.RoleRuleShow? <RoleRule onClose={this.HandleRoleRule.bind(this,false)}/>:''}
        {this.state.userinfo?<div
          ...
          <div className={style.UserRole} onClick={this.HandleRoleRule.bind(this,true)}>{this.state.userinfo.scorename}</div>
          <div className={style.UserInfoDetial}>
            ...
            <div className={style.Content}>
              <div className={style.BaseBox}><div>{this.state.userinfo.regionid}</div></div>
              <div className={style.BaseBox}><div>{this.state.userinfo.sex}</div></div>
